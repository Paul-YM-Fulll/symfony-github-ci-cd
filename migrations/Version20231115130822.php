 ...
 */
final class Version20231115130822 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__book AS SELECT id, title, author, year FROM book');
        $this->addSql('DROP TABLE book');
        $this->addSql('CREATE TABLE book (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, year VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO book (id, title, author, year) SELECT id, title, author, year FROM __temp__book');
        $this->addSql('DROP TABLE __temp__book');
    }
}
